...
use relus_core::job_config_loader;
use relus_core::relus_starter::start_job;
use relus_core::{init_and_watch_config, run_scheduler, run_serve};
...
fn main() -> std::process::ExitCode {
    ...
    relus_core::server::main(|| run_cli(command))
}

async fn run_cli(cmd: Commands) -> anyhow::Result<()> {
    match cmd {
